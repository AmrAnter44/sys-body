// Script to migrate attendance data from checkIn/checkOut to date-only format
...
async function main() {
  ...
  // First, add the date column if it doesn't exist
  try {
  ...
  // Now we can drop the old columns and create the new table structure
  ...
  console.log(`Migrated ${attendances.length} records`)
}
